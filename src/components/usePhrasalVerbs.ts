...
const PREPOSITIONS = [
  ...
  "In", "Into", "Off", "On", "Out", "Over", "Up", "Up with", "Forward", "With"
];
...
const INITIAL_VERBS = [
  ...
  { verb: "Come", meanings: ["Encontrarse con","Aparecer/Avanzar","","","Regresar","","Bajar","","Entrar","Toparse con","Desprenderse","¡Vamos!","Salir","Visitar/Venir","Subir/Surgir","Toparse con","",""] },
  ...
  { verb: "Look", meanings: ["across","","Buscar","","Recordar","","Despreciar","Buscar","Examinar/Investigar","Examinar/Investigar","","Observar/Cuidar","Tener cuidado","Pasar por alto","Buscar (info.)","","Esperar","Esperar con ansias"] },
